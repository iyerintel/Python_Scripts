...
# Store the different outputs as a tuple
cdp_neigh = (sw1_show_cdp_neighbors_detail,r1_show_cdp_neighbors_detail,r2_show_cdp_neighbors_detail,r3_show_cdp_neighbors_detail,
    r4_show_cdp_neighbors_detail,r5_show_cdp_neighbors_detail)
#These are the network devices dictionary
net_dev = {}


# Going over different neighbors
